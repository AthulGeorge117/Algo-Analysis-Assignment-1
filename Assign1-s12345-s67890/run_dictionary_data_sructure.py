...
def run_dictionary_data_structure(args):
    ...
    try:
        ...
        print(f"Data file {data_filename} doesn't exist.")
        usage()
    ...
    try:
        ...
        for line in command_file:
            ...
            end_time = time.time()
            all_command_run_times.append((end_time - start_time) * 1000)

        output_file.close()
        command_file.close()

        return all_command_run_times
    except FileNotFoundError as e:
